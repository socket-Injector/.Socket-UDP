...
PORT_TCP='5666';
PORT_UDP='5666';
SUB_DOMAIN=socket-tunnel.online
MYIP=$(wget -qO- icanhazip.com);
server_ip=$(curl -s https://api.ipify.org)
timedatectl set-timezone Asia/sy
...
~/.acme.sh/acme.sh --register-account -m hamzadev505@gmail.com --server zerossl
